...
<div class="container mt-2">
    ...
    <div class="row">
        <div class="col-4">
            <img class="img-fluid" src="ukazka/img/thumb-1920-1065466.png" alt="tlou2">
        </div>
...
<div class="container mt-2">
    ...
    <div class="row">
        <div class="col-4">
            <img class="img-fluid" src="ukazka/img/league%20of%20legends%20wallpaper%2047%20-%201920x1080.jpg" alt="lolko">
        </div>
...
<div class="container mt-2">
    ...
    <div class="row">
        <div class="col-4">
            <img class="img-fluid" src="ukazka/img/the_witcher_3___wallpaper_hd_4k_by_seiikya_d989ila-fullview.jpg"
                 alt="witcher">
        </div>
...
<div class="container mt-2">
    ...
    <div class="row">
        <div class="col-4">
            <img class="img-fluid" src="ukazka/img/Spellbreak_Hero_4k.jpg" alt="spellbreak">
        </div>
